...
if(psm1_pub_msg.getName.isEmpty == 1)
...
global psm1_pub_msg;
if (psm1_pub_msg.getName.size ~= 7)
    disp('Setting GUI Jnt Names. Error! Number of Joint Names is not equal to 7');
else
set(gui_handles.text1_psm1,'String',psm1_pub_msg.getName.get(0));
set(gui_handles.text2_psm1,'String',psm1_pub_msg.getName.get(1));
set(gui_handles.text3_psm1,'String',psm1_pub_msg.getName.get(2));
set(gui_handles.text4_psm1,'String',psm1_pub_msg.getName.get(3));
set(gui_handles.text5_psm1,'String',psm1_pub_msg.getName.get(4));
set(gui_handles.text6_psm1,'String',psm1_pub_msg.getName.get(5));
set(gui_handles.text7_psm1,'String',psm1_pub_msg.getName.get(6));
end
end