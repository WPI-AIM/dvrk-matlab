...
global PSM1;  
    ...
    PSM1.jnt_pub.publish(PSM1.jnt_msg);
end
...
if(PSM1.jnt_msg.getName.isEmpty == 1)
...
PSM1.jnt_msg.setPosition([joint1,joint2,joint3,joint4,joint5,joint6,joint7]);
end

function psm1_set_gui_jnt_names(gui_handles)
global PSM1;
if (PSM1.jnt_msg.getName.size ~= 7)
    disp('Setting GUI Jnt Names. Error! Number of Joint Names is not equal to 7');
else
set(gui_handles.text1_psm1,'String',PSM1.jnt_msg.getName.get(0));
set(gui_handles.text2_psm1,'String',PSM1.jnt_msg.getName.get(1));
set(gui_handles.text3_psm1,'String',PSM1.jnt_msg.getName.get(2));
set(gui_handles.text4_psm1,'String',PSM1.jnt_msg.getName.get(3));
set(gui_handles.text5_psm1,'String',PSM1.jnt_msg.getName.get(4));
set(gui_handles.text6_psm1,'String',PSM1.jnt_msg.getName.get(5));
set(gui_handles.text7_psm1,'String',PSM1.jnt_msg.getName.get(6));
end
end